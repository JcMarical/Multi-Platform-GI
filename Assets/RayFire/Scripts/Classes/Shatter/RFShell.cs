...
// TODO bridge mapping
// TODO inner and bridge material
// TODO First property
...
namespace RayFire
{
    ...
    public class RFShell
    {
        ...
        public static Mesh AddShell(Utils.Mesh rfMesh, Mesh unityMesh, bool bridge, bool subMerge, float thickness)
        {
            // No thickness
            if (thickness <= 0)
                return unityMesh;
            ...
            {
                Debug.Log ("Mesh " + unityMesh.name + " has no open edges. Shell disabled.");
                return unityMesh;
            }
